...
The INCLINE experiment was set up in four semi-natural alpine grasslands selected to represent a precipitation gradient from the continental, dry inland to the oceanic, humid coast. The sites are part of an established climate grid (Vestland Climate Grid (VCG), Klanderud et al. 2015; Vandvik et al. 2020).   
